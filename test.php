                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h2 class="mb-lg-5 mb-4">About Anodaz Scan</h2>
                        </div>
            
                        <div class="col-lg-5 col-12 ms-auto mb-4 mb-lg-0 text-end" dir="rtl">
                            <!--<h3 class="mb-3"></h3>-->
            
                            <p><strong>Anodaz Scan</strong> </p>
                            <p>  ، وسيط بين المبرمجين الذين يمتلكون المهارات والقدرة على تنفيذ المشاريع التقنية وبين العملاء الذين يبحثون عن حلول تقنية لأعمالهم</p>
                            <p>تهدف إلى توفير بيئة مواتية للتعامل بين الطرفين، مما يضمن تنفيذ المشاريع بجودة عالية وبأسعار تنافسية</p>
            
                            <p>نحن نضمن التواصل السلس والشفاف بين المبرمجين والعملاء، ونسهل عملية البحث والتوظيف للمبرمجين المناسبين لكل مشروع. كما نسعى لتوفير تجربة ممتعة ومربحة لكل الأطراف المتعاملة معنا.</p>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 me-auto mb-4 mb-lg-0">
                                                                            ...
                                                                            <p><strong>Anodaz Scan</strong>نحن </p>
                            <p>  ، وسيط بين المبرمجين الذين يمتلكون المهارات والقدرة على تنفيذ المشاريع التقنية وبين العملاء الذين يبحثون عن حلول تقنية لأعمالهم</p>
                              <p>تهدف إلى توفير بيئة مواتية للتعامل بين الطرفين، مما يضمن تنفيذ المشاريع بجودة عالية وبأسعار تنافسية</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12">
                            <form action="#" method="post" class="custom-form contact-form" role="form">
                                <h2 class="mb-4 pb-2">Contact Anodaz Scan</h2>
